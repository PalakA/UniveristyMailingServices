	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
		<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
			...
			<li class="nav-item"><a class="nav-link"
				href="/universitymailservices/mailAssociateHome/mailAssociateEditProfile"
		...
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class="card">
					...
					<div class="card-body">
						<form name="my-form"
							action="/universitymailservices/mailAssociateHome/mailAssociateEditProfile"
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="text" id="email_address" class="form-control"
										name="email_address" value="${mailAssociate.getEmailId()}"
										readonly="true">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="text" id="firstName" class="form-control"
										name="firstName" value="${mailAssociate.getFirstName()}">
								</div>
							</div>
							<div class="form-group row">
								<label for="last_name"
								...
								<div class="col-md-6">
									<input type="text" id="lastName" class="form-control"
										name="lastName" value="${mailAssociate.getLastName()}">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="number" id="phonenumber" class="form-control"
										name="phonenumber" value="${mailAssociate.getMobileNumber()}">
								</div>
							</div>
