	...
	function validateForm() {
		...
		if (!document.getElementById('passwordCheck').checked) {
			if (($('#password').val() == '')
				...
				alert("Please uncheck the box if you don't wish to change your password.");
				return false;
			}
		}
		if (!document.getElementById('passwordCheck').checked) {
	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
		<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
			<li class="nav-item active"><a class="nav-link"
				href="/facilitiesCoordinatorHome">Home </a></li>
			<li class="nav-item"><a class="nav-link"
				href="/universitymailservices/facilitiesCoordinatorHome/createEmployees"
				type="button" title="Click to add new employess">Create
					Employees</a></li>
			<li class="nav-item"><a class="nav-link"
				href="/universitymailservices/facilitiesCoordinatorHome/mailroom"
				type="button" title="Click to view mailroom system">Mail Room
					CRM</a></li>
			<li class="nav-item"><a class="nav-link"
				href="/universitymailservices/facilitiesCoordinatorHome/facilitiesCoordinatorEditProfile"
				type="button" title="Click to edit your profile">Edit Your
		...
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class="card">
					...
					<div class="card-body">
						<form name="my-form"
							action="/universitymailservices/facilitiesCoordinatorHome/facilitiesCoordinatorEditProfile"
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="text" id="email_address" class="form-control"
										name="email_address"
										value="${facilitiesCoordinator.getEmailId()}" readonly="true">
								</div>
							</div>
							<div class="form-group row">
								<label for="full_name"
								...
								<div class="col-md-6">
									<input type="text" id="firstName" class="form-control"
										name="firstName"
										value="${facilitiesCoordinator.getFirstName()}">
								</div>
							</div>
							<div class="form-group row">
								<label for="last_name"
								...
								<div class="col-md-6">
									<input type="text" id="lastName" class="form-control"
										name="lastName" value="${facilitiesCoordinator.getLastName()}">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="number" id="phonenumber" class="form-control"
										name="phonenumber"
										value="${facilitiesCoordinator.getMobileNumber()}">
								</div>
							</div>
							...
							<div class="col-md-6 offset-md-4">
								...
								<input type="hidden" id="id" name="id"
									value="${facilitiesCoordinator.getUserid()}" />
							</div>
						</form>
					</div>
				</div>
